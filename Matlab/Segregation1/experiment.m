...
mu(:,1) = feature_expectations(P, discount, D, Pol{1}, num_samples, num_steps, num_features, phis);
i = 2;
...
while 1
    ...
    % 5.
    mu(:,i) = feature_expectations(P, discount, D, Pol{i}, num_samples, num_steps, num_features, phis);
